...
const FIELD_LABELS: Record<string, string> = {
  ...
  usable: "Usable",
  declared_claims_count: "Declared claims",
  email_claims_count: "Claims in emails",
  unsupported_claims_count: "Unsupported claims",
  safety_confidence_avg: "Avg confidence",
  emails_safe_count: "Emails safe",
  emails_total: "Emails total",
  final_email_safe: "All safe",
  verification_ok: "Verifier ok",
